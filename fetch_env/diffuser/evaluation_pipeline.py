...
def main():
    ...
    if "Obstacle" in Args.dataset:
        weight, weighted_generated_states = filter_states(Args.dataset, generated_states, Args.model_type, offset=0.02)
    else:
        weight = 1
