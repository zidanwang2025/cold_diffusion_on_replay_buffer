...
class SequenceDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, env='maze2d-large-v1', horizon=64,
        ...
        max_n_episodes=1000, termination_penalty=0, use_padding=True, validation=False, dataset_size="1.6k",
        data_path=None, observation_dim=4, action_dim=2):
    ...
    def __getitem__(self, idx, eps=1e-4):
        ...
        observations = self.fields.normed_observations[path_idx, start:end]
        actions = self.fields.normed_actions[path_idx, start:end]

        conditions = self.get_conditions(observations)
        trajectory = np.concatenate([actions, observations], axis=-1)
