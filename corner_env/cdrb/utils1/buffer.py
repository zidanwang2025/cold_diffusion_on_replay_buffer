...
class ReplayBuffer:
    ...
    def add_path(self, path):
        if self._count == self.max_n_episodes: #added to avoid index out-of-bound error
            return
        ...
        for key in self.keys:
            ...
            # Make it a bit more robust to different dimensions
            # In the old dataset `array` was (batch_size, dim)
            # The new one is (batch_size, 1, dim)
